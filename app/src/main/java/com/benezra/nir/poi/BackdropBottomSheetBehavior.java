 ...
 * {@link GoogleMapsBottomSheetBehavior} in the XML file to get same behavior like Google Maps.
...
public class BackdropBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    /**
     * To avoid using multiple "peekheight=" in XML and looking flexibility allowing {@link GoogleMapsBottomSheetBehavior#mPeekHeight}
     * get changed dynamically we get the {@link NestedScrollView} that has
     * "app:layout_behavior=" {@link GoogleMapsBottomSheetBehavior} inside the {@link CoordinatorLayout}
     */
    private WeakReference<GoogleMapsBottomSheetBehavior> mBottomSheetBehaviorRef;
    /**
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, View child, View dependency) {
        if (dependency instanceof NestedScrollView) {
            try {
                GoogleMapsBottomSheetBehavior.from(dependency);
                return true;
            }
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
         ...
         * flexibility, in case that dependency's height, child's height or {@link GoogleMapsBottomSheetBehavior#getPeekHeight()}'s
         ...
         * {@link GoogleMapsBottomSheetBehavior#getPeekHeight()} and collapsedY are the same point on screen.
         */
    ...
    /**
     * Look into the CoordiantorLayout for the {@link GoogleMapsBottomSheetBehavior}
     * @param coordinatorLayout with app:layout_behavior= {@link GoogleMapsBottomSheetBehavior}
     */
    private void getBottomSheetBehavior(@NonNull CoordinatorLayout coordinatorLayout) {
        ...
        for (int i = 0; i < coordinatorLayout.getChildCount(); i++) {
            ...
            if (child instanceof NestedScrollView) {
                ...
                try {
                    GoogleMapsBottomSheetBehavior temp = GoogleMapsBottomSheetBehavior.from(child);
