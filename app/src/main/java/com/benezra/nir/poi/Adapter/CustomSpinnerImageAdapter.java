...
public class CustomSpinnerImageAdapter extends BaseAdapter implements SpinnerAdapter {

    private final Context activity;
    private ArrayList<String> asr;

    public CustomSpinnerImageAdapter(Context context, ArrayList<String> asr) {
        this.asr=asr;
        sortList();
        activity = context;
    }
...
//        return  txt;
        ...
        TextView titleTextView = (TextView) listItemView.findViewById(R.id.tv_spinner_dropdown);
        titleTextView.setText(asr.get(position));
