...
public class ImageCameraDialogFragmentNew extends DialogFragment{

    private ImageCameraDialogCallbackNew mListener;
    private Context mContext;
    private Uri mPicUri;

    private final static String TAG = ImageCameraDialogFragmentNew.class.getSimpleName();
    ...
    public static ImageCameraDialogFragmentNew newInstance() {
        return new ImageCameraDialogFragmentNew();
    }

    public ImageCameraDialogFragmentNew() {
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ImageCameraDialogFragmentNew.ImageCameraDialogCallbackNew) {
            mListener = (ImageCameraDialogFragmentNew.ImageCameraDialogCallbackNew) context;
        }
    }
